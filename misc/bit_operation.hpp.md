...
data:
  ...
  bundledCode: "#line 1 \"misc/bit_operation.hpp\"\n\n\n\n/**\n * @brief bit operations\
    ...
    \ 28, 62, 5,  39, 46, 44, 42,\n      22, 9,  24, 35, 59, 56, 49, 18, 29, 11, 63,\
    \ 52, 6,  26, 37, 40, 33, 47, 61, 45, 43, 21,\n      23, 58, 17, 10, 51, 25, 36,\
    \ 32, 60, 20, 57, 16, 50, 31, 19, 15, 30, 14, 13, 12};\n  return convert[n * deBruijn\
    \ >> 58];\n}\n\nint deBruijn_log2(std::uint32_t n) {\n  static constexpr std::uint32_t\
    \ deBruijn = 0x4653adf;\n  static constexpr int convert[32]        = {0,  1, \
    \ 2,  6,  3,  11, 7,  16, 4,  14, 12,\n                                      21,\
    \ 8,  23, 17, 26, 31, 5,  10, 15, 13, 20,\n                                  \
