...
data:
  ...
  bundledCode: "#line 2 \"basis.hpp\"\n\n#line 2 \"mat_basic.hpp\"\n\n#line 2 \"poly.hpp\"\
    ...
    \ [q, r] = euclidean_div(*this, R);\n        return std::make_pair(Poly(q.begin(),\
  ...
  code: "#pragma once\n\n#include \"mat_basic.hpp\"\n#include <cassert>\n#include\
    \ <optional>\n#include <vector>\n\ntemplate <typename Tp>\nclass Basis {\npublic:\n\
    \    const int Dim;\n    Matrix<Tp> Vectors; // v_0, v_1, ...\n    Matrix<Tp>\
    \ Augmented;\n    Matrix<Tp> Reduced; // upper triangular matrix, diagonal of\
    \ Reduced = (1,...,1)\n    // Augmented * Vectors = Reduced\n\n    explicit Basis(int\
    \ dim) : Dim(dim), Augmented(dim), Reduced(dim) {}\n\n    int size() const { return\
    \ Vectors.size(); }\n    int dim() const { return Dim; }\n\n    // if V is linear\
    \ combination of v_0, ..., v_(k-1) then\n    // returns coefficients (a_0, ...,\
    \ a_(k-1)) s.t. -(a_0v_0 + ... + a_(k-1)v_(k-1)) = V\n    std::optional<std::vector<Tp>>\
  ...
  requiredBy:
  - frobenius.hpp
  timestamp: '2024-08-13 21:13:49+08:00'
