...
data:
  ...
  bundledCode: "#line 2 \"eulerian_number.hpp\"\n\n#line 2 \"binomial.hpp\"\n\n#include\
    ...
    \ = 0; i <= n; ++i) A[i] = Tp(i + 1).pow(n);\n    auto AA = convolution_fft(A,\
    \ pow(std::vector<Tp>{Tp(1), Tp(-1)}, n + 1, n + 1));\n    AA.resize(n + 1);\n\
...
layout: document
redirect_from:
- /library/eulerian_number.hpp
- /library/eulerian_number.hpp.html
