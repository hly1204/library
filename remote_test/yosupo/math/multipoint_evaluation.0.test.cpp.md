...
data:
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/multipoint_evaluation\"\
    ...
    \ (auto &i : x_set) std::cin >> i;\r\n  auto y_set = lib::evaluate(f, x_set);\r\
