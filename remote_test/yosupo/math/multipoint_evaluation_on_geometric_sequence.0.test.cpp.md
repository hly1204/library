...
data:
  ...
  bundledCode: "#line 1 \"remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp\"\
    ...
    \ &rhs) {\n    return os << rhs.val();\n  }\n};\n\ntemplate <std::uint32_t ModT>\n\
    using mm30 = montgomery_modint30<ModT>;\n\nLIB_END\n\n\n#line 5 \"remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp\"\
    \n\n#line 8 \"remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp\"\
    \n#include <iterator>\n#line 10 \"remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp\"\
    \n\nint main() {\n#ifdef LOCAL\n  std::freopen(\"in\", \"r\", stdin), std::freopen(\"\
    out\", \"w\", stdout);\n#endif\n  std::ios::sync_with_stdio(false);\n  std::cin.tie(nullptr);\n\
    \  using mint = lib::mm30<998244353>;\n  int n, m;\n  mint a, r;\n  std::cin >>\
    \ n >> m >> a >> r;\n  std::vector<mint> f;\n  std::copy_n(std::istream_iterator<mint>(std::cin),\
    \ n, std::back_inserter(f));\n  std::transform(f.cbegin(), f.cend(), f.begin(),\
    \ [aa = mint(1), &a](const mint &x) mutable {\n    mint xx = x * aa;\n    aa *=\
    \ a;\n    return xx;\n  });\n  auto ff = lib::czt(f, r, m);\n  std::copy(ff.cbegin(),\
    \ ff.cend(), std::ostream_iterator<mint>(std::cout, \" \"));\n  return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2023-04-16 15:25:06+08:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp
layout: document
redirect_from:
- /verify/remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp
- /verify/remote_test/yosupo/math/multipoint_evaluation_on_geometric_sequence.0.test.cpp.html
