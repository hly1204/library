...
data:
  ...
  bundledCode: "#line 1 \"remote_test/yosupo/datastructure/staticrmq.0.test.cpp\"\n\
    ...
    #include <cassert>\n#include <cstdint>\n#include <functional>\n#line 15 \"datastructure/basic/sparse_table.hpp\"\
    ...
    \ Comp cmp = Comp()) {\n  std::function<Type(const Type &, const Type &)> min_ele\
    \ = [&cmp](const Type &x, const Type &y) {\n    return cmp(x, y) ? x : y;\n  };\n\
    \  return SparseTable<Type, std::function<Type(const Type &, const Type &)>>(init_v,\
    \ min_ele);\n}\n\n} // namespace lib\n\n\n#line 6 \"remote_test/yosupo/datastructure/staticrmq.0.test.cpp\"\
