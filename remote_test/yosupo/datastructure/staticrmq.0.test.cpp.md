...
data:
  ...
  bundledCode: "#line 1 \"remote_test/yosupo/datastructure/staticrmq.0.test.cpp\"\n\
    ...
    \ <typename Type, typename FoldFunc> class SparseTable {\npublic:\n  static std::uint32_t\
    \ log2_floor(std::uint32_t n) {\n    n >>= 1, n |= n >> 1, n |= n >> 2, n |= n\
    \ >> 4, n |= n >> 8, n |= n >> 16, ++n;\n    static constexpr std::uint32_t deBruijn\
    \ = 0x4653adf;\n    static constexpr std::uint32_t convert[32] = {0,  1,  2, \
    \ 6,  3,  11, 7,  16, 4,  14, 12,\n                                          \
    \        21, 8,  23, 17, 26, 31, 5,  10, 15, 13, 20,\n                       \
    \                           22, 25, 30, 9,  19, 24, 29, 18, 28, 27};\n    return\
    \ convert[n * deBruijn >> 27];\n  }\n  template <typename Container>\n  SparseTable(const\
    ...
    \ 5 \"remote_test/yosupo/datastructure/staticrmq.0.test.cpp\"\n\nint main() {\n\
