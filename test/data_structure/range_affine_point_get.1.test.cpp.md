...
data:
  ...
  bundledCode: "#line 1 \"test/data_structure/range_affine_point_get.1.test.cpp\"\n\
    ...
    };\n#line 7 \"test/data_structure/range_affine_point_get.1.test.cpp\"\n\nint main()\
  ...
  verifiedWith: []
documentation_of: test/data_structure/range_affine_point_get.1.test.cpp
layout: document
redirect_from:
- /verify/test/data_structure/range_affine_point_get.1.test.cpp
- /verify/test/data_structure/range_affine_point_get.1.test.cpp.html
