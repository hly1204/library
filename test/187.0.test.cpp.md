...
data:
  ...
  bundledCode: "#line 1 \"test/187.0.test.cpp\"\n#define PROBLEM \"https://yukicoder.me/problems/448\"\
    ...
    \ pp[n]};\n}\n#line 4 \"test/187.0.test.cpp\"\n#include <algorithm>\n#include\
    \ <iostream>\n#line 7 \"test/187.0.test.cpp\"\n\nint main() {\n    std::ios::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n    int n;\n    std::cin >> n;\n    std::vector<int>\
  ...
  verifiedWith: []
documentation_of: test/187.0.test.cpp
layout: document
redirect_from:
- /verify/test/187.0.test.cpp
- /verify/test/187.0.test.cpp.html
