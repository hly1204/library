...
data:
  ...
  bundledCode: "#line 1 \"test/other/consecutive_terms_of_linear_recurrent_sequence.0.test.cpp\"\
    ...
    \ Iterator> inline void fft_doubling_n(Iterator a, int n) {\n    using Tp = typename\
    \ std::iterator_traits<Iterator>::value_type;\n    assert((n & (n - 1)) == 0);\n\
    \    std::copy_n(a, n, a + n);\n    inv_fft_n(a + n, n);\n    Tp k         = 1;\n\
    \    const auto t = FftInfo<Tp>::get().root(n).at(n / 2);\n    for (int i = 0;\
    \ i < n; ++i) a[i + n] *= k, k *= t;\n    fft_n(a + n, n);\n}\n\ntemplate<typename\
    \ Tp> inline void fft_doubling(std::vector<Tp> &a) {\n    const int n = a.size();\n\
    ...
    \ ord(Q)=0\ntemplate<typename Tp> inline std::vector<Tp>\nslice_coeff_rational(const\
    \ std::vector<Tp> &P, const std::vector<Tp> &Q, long long L, long long R) {\n\
    ...
    \ std::vector<Tp> &P, const std::vector<Tp> &Q, long long k) {\n    return slice_coeff_rational(P,\
    \ Q, k, k + 1).at(0);\n}\n#line 2 \"modint.hpp\"\n\n#include <iostream>\n#line\
    ...
    \ &b) { return a << b.val(); }\n};\n// clang-format on\n#line 8 \"test/other/consecutive_terms_of_linear_recurrent_sequence.0.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/other/consecutive_terms_of_linear_recurrent_sequence.0.test.cpp
layout: document
redirect_from:
- /verify/test/other/consecutive_terms_of_linear_recurrent_sequence.0.test.cpp
- /verify/test/other/consecutive_terms_of_linear_recurrent_sequence.0.test.cpp.html
