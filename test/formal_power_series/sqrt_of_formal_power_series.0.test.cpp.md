...
data:
  ...
  bundledCode: "#line 1 \"test/formal_power_series/sqrt_of_formal_power_series.0.test.cpp\"\
    ...
    \ Tp>\ninline std::optional<std::vector<Tp>> fps_sqrt(const std::vector<Tp> &a,\
    \ int n) {\n    const int o = order(a);\n    if (o < 0) return std::vector<Tp>(n);\n\
    ...
    \ &b) { return a << b.val(); }\n};\n// clang-format on\n#line 7 \"test/formal_power_series/sqrt_of_formal_power_series.0.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/formal_power_series/sqrt_of_formal_power_series.0.test.cpp
- /verify/test/formal_power_series/sqrt_of_formal_power_series.0.test.cpp.html
