...
data:
  ...
  bundledCode: "#line 1 \"test/formal_power_series/polynomial_interpolation_on_geometric_sequence.0.test.cpp\"\
    ...
    \  - binom(j,2)\ntemplate<typename Tp> inline std::vector<Tp> czt(std::vector<Tp>\
    \ F, Tp c, int n, Tp a = 1) {\n    if (n <= 0) return {};\n    const int degF\
    ...
    \ &b) { return a << b.val(); }\n};\n// clang-format on\n#line 7 \"test/formal_power_series/polynomial_interpolation_on_geometric_sequence.0.test.cpp\"\
...
layout: document
redirect_from:
- /verify/test/formal_power_series/polynomial_interpolation_on_geometric_sequence.0.test.cpp
- /verify/test/formal_power_series/polynomial_interpolation_on_geometric_sequence.0.test.cpp.html
