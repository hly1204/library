...
data:
  ...
  bundledCode: "#line 1 \"test/set_power_series/log_of_set_power_series.0.test.cpp\"\
    ...
    \    }\n    return res;\n}\n#line 7 \"test/set_power_series/log_of_set_power_series.0.test.cpp\"\
    \n\nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    using mint = ModInt<998244353>;\n    int n;\n    std::cin >> n;\n    std::vector<mint>\
    \ a(1 << n);\n    for (int i = 0; i < (1 << n); ++i) std::cin >> a[i];\n    const\
    \ auto expa = sps_exp(a);\n    assert(sps_log(expa) == a);\n    for (int i = 0;\
    \ i < (1 << n); ++i) std::cout << expa[i] << ' ';\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/set_power_series/log_of_set_power_series.0.test.cpp
- /verify/test/set_power_series/log_of_set_power_series.0.test.cpp.html
